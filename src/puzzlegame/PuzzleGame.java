        ...
        theScene.setOnKeyReleased(
            ...
            public void handle(KeyEvent e) {
                ...
                if (input.contains("LEFT")) {
                    ...
                    if ((playerX - 1 >= 0) && (walls[playerY][(playerX - 1)] != 1) && (moveBoxes[playerY][(playerX - 1)] != 1)) {
                        boxes[playerY][playerX].setFill(Color.WHITE);
                        boxes[playerY][playerX].setStroke(Color.BLACK);
                        playerX -= 1;
                        boxes[playerY][playerX].setFill(Color.CRIMSON);
                        steps -= 1;
                    }else if(playerX - 2 >= 0 && (walls[playerY][(playerX - 2)] != 1) && (moveBoxes[playerY][(playerX - 1)] == 1)){
                        pushWall("left");
                    }
                    looking = "left";
                    t.setText("Looking: " + looking);
                    ...
                    if (playerX + 1 < sizeX && (walls[playerY][(playerX + 1)] != 1) && (moveBoxes[playerY][(playerX + 1)] != 1)) {
                        ...
                        boxes[playerY][playerX].setFill(Color.CRIMSON);
                        steps -= 1;
                    }else if(playerX + 2 < sizeX && (walls[playerY][(playerX + 2)] != 1) && (moveBoxes[playerY][(playerX + 1)] == 1)){
                        pushWall("right");
                    }
                    looking = "right";
                    t.setText("Looking: " + looking);
                    ...
                    t.setText("Looking: " + looking);
                    stepText.setText("Steps Left: " + steps);
                    if ((playerY + 1 < sizeY-1) && (walls[(playerY + 1)][playerX] != 1) && (moveBoxes[playerY + 1][(playerX)] != 1)) {
                        boxes[playerY][playerX].setFill(Color.WHITE);
                        boxes[playerY][playerX].setStroke(Color.BLACK);
                        playerY += 1;
                        boxes[playerY][playerX].setFill(Color.CRIMSON);
    ...
    public void wallRow(int y) {
     ...
     public void pushWall(String direction){
         if(direction.equals("right")){
                   boxes[playerY][playerX].setFill(Color.WHITE);
                   boxes[playerY][playerX].setStroke(Color.BLACK);
                   moveBoxes[playerY][playerX +2] = 1;
                   boxes[playerY][playerX + 2].setFill(Color.DARKGRAY);
                    boxes[playerY][playerX + 2].setStroke(Color.WHITE);
